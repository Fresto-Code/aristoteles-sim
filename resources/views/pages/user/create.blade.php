            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right" :value="__(Confirm Password)">{{ __('Konfirmasi Kata Sandi') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                                    ...
                                    <option value="osis" @if(old('role')=='osis' ) selected @endif>Osis</option>
                                    <option value="principal" @if(old('role')=='principal' ) selected @endif>Principal</option>
                                </select>
