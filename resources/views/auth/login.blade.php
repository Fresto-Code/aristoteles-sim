        ...
        <div class="col-lg-5 col-md-7">
            <div class="card bg-secondary shadow border-0">
                ...
                <div class="card-body px-lg-5 py-lg-5">
                    <form role="form" method="POST" action="{{ route('own_login') }}">
                        @csrf
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }} mb-3">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }} {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email / Username') }}" type="username" name="username" value="{{ old('username') }}" value="{{old('username')}}" required autofocus>
                            </div>
